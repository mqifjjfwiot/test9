...
CREATE TABLE BOARD
(
	BONO varchar2(2001) NOT NULL,
	NO number NOT NULL,
	SNO varchar2(2000) NOT NULL,
	CATEGORY varchar2(20000) NOT NULL,
...
(
	PNO varchar2(100) NOT NULL,
	DELIVERYPAY varchar2(50000) NOT NULL,
	COUPON nvarchar2(20),
	PVIEW varchar2(2022) NOT NULL,
	PBUYCOUNT number(50000) NOT NULL,
	PSCORE varchar2(50000) NOT NULL,
	PTAG nvarchar2(200),
	PRIMARY KEY (PNO)
);
